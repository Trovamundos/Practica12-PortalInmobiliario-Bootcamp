...
var url = "".concat("http://localhost:3000/api", "/properties"); //a1.4 Metodo para recuperar el array.
...
var saleTypeListUrl = "".concat("http://localhost:3000/api", "/saleTypes"); // b1.3 Metodo para recuperar la lista de ventas.
...
var provinceListUrl = "".concat("http://localhost:3000/api", "/provinces"); // b1.5 Metodo para recuperar la lista de provincias.
...
var mapFilterToQueryParams = function mapFilterToQueryParams(filter) {
  var queryParams = ''; //d4.2 Preguntar si saleTypeId tiene valor para filtrar.
...
Promise.all([(0, _propertyList.getPropertyList)(), (0, _propertyList.getSaleTypeList)(), (0, _propertyList.getProvincesList)() // al .then llega un array de resultados.
]).then(function (_ref) {
  ...
  loadPropertyList(propertyList); // b4.1 Pintar las listas.

  (0, _propertyList3.setOptions)(saleTypeList, 'select-sale-type', '¿Qué venta?');
  (0, _propertyList3.setOptions)(provinceList, 'select-province', '¿Dónde?'); //c2.1 Pintar el array.
...
var loadPropertyList = function loadPropertyList(propertyList) {
  ...
  var viewModelPropertyList = (0, _propertyList2.mapPropertyListFromApiToViewModel)(propertyList); // a5.1 Pintar la lista.
...
(0, _helpers.onUpdateField)('select-sale-type', function (event) {
  ...
  var value = event.target.value; // d2.3 Actualizar el objeto filter.
...
(0, _helpers.onSubmitForm)('search-button', function () {
  ...
  var queryParams = (0, _propertyList2.mapFilterToQueryParams)(filter); // e1.1 Antes de pedir datos al servidor limpiamos el html.

  (0, _propertyList3.clearPropertyRows)(); //d4.7 volver a pedir la lista de propiedades.
