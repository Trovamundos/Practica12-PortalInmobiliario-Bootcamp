...
exports.insertNewProperty = exports.getEquipmentList = exports.getSaleTypeList = exports.getProvinceList = void 0;

var _axios = _interopRequireDefault(require("axios"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var urlProvinces = "".concat("http://localhost:3000/api", "/provinces");
var urlSaleTypes = "".concat("http://localhost:3000/api", "/saleTypes");
var urlEquipment = "".concat("http://localhost:3000/api", "/equipments");
var urlProperties = "".concat("http://localhost:3000/api", "/properties");

var getProvinceList = function getProvinceList() {
  return _axios.default.get(urlProvinces).then(function (response) {
...
var getSaleTypeList = function getSaleTypeList() {
  return _axios.default.get(urlSaleTypes).then(function (response) {
    return response.data;
  });
};
...
var getEquipmentList = function getEquipmentList() {
  return _axios.default.get(urlEquipment).then(function (response) {
    return response.data;
  });
};
...
var insertNewProperty = function insertNewProperty(newProperty) {
  return _axios.default.post(urlProperties, newProperty).then(function (response) {
    return response.data;
  });
};
...
exports.formUploadPropertyValidation = void 0;
...
var validationSchema = {
  field: {
    ...
    saleTypes: [{
      validator: _fonkArrayRequiredValidator.arrayRequired,
    ...
    locationUrl: [{
      ...
      validator: _fonkIsUrlValidator.isUrl,
      message: 'Por favor, introduzca un formato válido'
    }]
  }
};
var formUploadPropertyValidation = (0, _fonk.createFormValidation)(validationSchema);
exports.formUploadPropertyValidation = formUploadPropertyValidation;
...
var addElement = function addElement(element, value) {
  return _objectSpread(_objectSpread({}, newProperty), {}, _defineProperty({}, element, [].concat(_toConsumableArray(newProperty[element]), [value])));
};

var removeElement = function removeElement(element, value) {
  return _objectSpread(_objectSpread({}, newProperty), {}, _defineProperty({}, element, newProperty[element].filter(function (el) {
    return el !== value;
  })));
};

var getEvent = function getEvent(list, element) {
...
Promise.all([(0, _uploadProperty.getSaleTypeList)(), (0, _uploadProperty.getProvinceList)(), (0, _uploadProperty.getEquipmentList)()]).then(function (_ref) {
...
(0, _helpers.onUpdateField)('title', function (event) {
  ...
  _uploadProperty3.formUploadPropertyValidation.validateField('title', transfer.title).then(function (result) {
...
(0, _helpers.onUpdateField)('notes', function (event) {
  ...
  _uploadProperty3.formUploadPropertyValidation.validateField('notes', transfer.notes).then(function (result) {
...
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  _uploadProperty3.formUploadPropertyValidation.validateField('email', transfer.email).then(function (result) {
...
(0, _helpers.onUpdateField)('phone', function (event) {
  ...
  _uploadProperty3.formUploadPropertyValidation.validateField('phone', transfer.phone).then(function (result) {
...
(0, _helpers.onUpdateField)('price', function (event) {
  ...
  _uploadProperty3.formUploadPropertyValidation.validateField('price', transfer.price).then(function (result) {
...
(0, _helpers.onUpdateField)('address', function (event) {
  ...
  _uploadProperty3.formUploadPropertyValidation.validateField('address', transfer.address).then(function (result) {
...
(0, _helpers.onUpdateField)('city', function (event) {
  ...
  _uploadProperty3.formUploadPropertyValidation.validateField('city', transfer.city).then(function (result) {
...
(0, _helpers.onUpdateField)('province', function (event) {
  ...
  _uploadProperty3.formUploadPropertyValidation.validateField('province', transfer.provinceId).then(function (result) {
...
(0, _helpers.onUpdateField)('squareMeter', function (event) {
  ...
  _uploadProperty3.formUploadPropertyValidation.validateField('squareMeter', transfer.squareMeter).then(function (result) {
...
(0, _helpers.onUpdateField)('rooms', function (event) {
  ...
  _uploadProperty3.formUploadPropertyValidation.validateField('rooms', transfer.rooms).then(function (result) {
...
(0, _helpers.onUpdateField)('bathrooms', function (event) {
  ...
  _uploadProperty3.formUploadPropertyValidation.validateField('bathrooms', transfer.bathrooms).then(function (result) {
...
(0, _helpers.onUpdateField)('locationUrl', function (event) {
  ...
  _uploadProperty3.formUploadPropertyValidation.validateField('locationUrl', transfer.locationUrl).then(function (result) {
...
(0, _helpers.onSubmitForm)('insert-feature-button', function () {
  ...
  if (value) {
    var deleteId = (0, _uploadProperty2.formatDeleteFeatureButtonId)(value);
...
(0, _helpers.onSubmitForm)('save-button', function () {
  _uploadProperty3.formUploadPropertyValidation.validateForm(newProperty).then(function (result) {
    ...
    if (result.succeeded) {
      ...
      (0, _uploadProperty.insertNewProperty)(newProperty).then(function (element) {
        console.log(element);
      });
    } else {
