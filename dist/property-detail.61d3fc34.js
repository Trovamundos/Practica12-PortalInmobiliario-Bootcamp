...
exports.insertContactDetail = exports.getEquipmentList = exports.getPropertyList = void 0;
...
var getPropertyList = function getPropertyList(id) {
  return _axios.default.get("".concat(urlProperties, "/").concat(id)).then(function (response) {
...
var insertContactDetail = function insertContactDetail(contactDetail) {
  return _axios.default.post(urlContact, contactDetail).then(function (response) {
    return response.data;
  });
};

exports.insertContactDetail = insertContactDetail;
...
var equipments = [];
(0, _propertyDetail.getEquipmentList)().then(function (data) {
  equipments = data.map(function (item) {
    return item.name;
  });
});
...
var getBathroomWord = function getBathroomWord(rooms) {
...
exports.formContactValidation = void 0;
...
var formContactValidation = (0, _fonk.createFormValidation)(validationSchema);
exports.formContactValidation = formContactValidation;
...
(0, _propertyDetail.getPropertyList)(params.id).then(function (propertyList) {
  var viewModelPropertyList = (0, _propertyDetail2.mapPropertyFromApiToViewModel)(propertyList);
  (0, _propertyDetail3.setPropertyValues)(viewModelPropertyList);
});
var contactDetail = {
  email: '',
  message: ''
...
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  contactDetail = _objectSpread(_objectSpread({}, contactDetail), {}, {
    email: value
  });

  _propertyDetail4.formContactValidation.validateField('email', contactDetail.email).then(function (result) {
...
(0, _helpers.onUpdateField)('message', function (event) {
  ...
  _propertyDetail4.formContactValidation.validateField('message', contactDetail.message).then(function (result) {
    (0, _helpers.onSetError)('message', result);
  });
});
(0, _helpers.onSubmitForm)('contact-button', function () {
  _propertyDetail4.formContactValidation.validateForm(contactDetail).then(function (result) {
    ...
    if (result.succeeded) {
      ...
      (0, _propertyDetail.insertContactDetail)(contactDetail).then(function (element) {
        console.log(element);
      });
    } else {
